...
<div class="mt-36">
    <div id="about">
        <div class="relative overflow-hidden bg-gray-100 pt-16 pb-32 space-y-24">
            <div class="relative">
                <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
                    <div class="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 ">
                        ...
                        <div>
                            <div>
                                <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-yellow-800">
                            ...
                            <div class="mt-6">
                                ...
                                <div class="mt-6">
                                    <a class="inline-flex rounded-lg bg-yellow-800 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-yellow-600 hover:bg-yellow-700 hover:ring-yellow-700"
                                        href="/login">
                                        Learn More
                                    </a>
                                </div>
                    ...
                    <div class="mt-12 sm:mt-16 lg:mt-0">
                        <div class="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                            <img loading="lazy" width="647" height="486"
                                ...
                                style="color:transparent" src="{{asset('assets/image/building/building2.jpg')}}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="mt-12 sm:mt-16 lg:mt-0">
                        <div class="-ml-48 pr-6 md:-ml-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                            <img alt="Inbox user interface" loading="lazy" width="647" height="486"
                                ...
                                style="color:transparent" src="{{asset('assets/image/bed/bed6.jpg')}}">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="mt-12 sm:mt-16 lg:mt-0">
                        <div class="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                            <img loading="lazy" width="646" height="485"
                                ...
                                src="{{asset('assets/image/lobby/lobby3.jpg')}}">
                        </div>
                    </div>
                </div>
            </div>
