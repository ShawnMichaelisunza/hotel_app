<div class="top-nav inset-x-0 top-0 z-50">
        ...
        <div class="mx-auto max-w-7xl py-3 px-3 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center justify-between lg:flex-row lg:justify-center">
                ...
                <div class="mt-2 w-full flex-shrink-0 lg:mt-0 lg:w-auto"><a
                        class="flex items-center justify-center rounded-md border border-transparent bg-yellow-800 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-yellow-700"
